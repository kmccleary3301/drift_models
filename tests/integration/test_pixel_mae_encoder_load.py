...
def test_pixel_can_load_exported_mae_encoder(tmp_path: Path) -> None:
...
def test_pixel_can_load_legacy_exported_mae_encoder(tmp_path: Path) -> None:
    repo_root = Path(__file__).resolve().parents[2]
...
def test_pixel_can_load_paper_arch_exported_mae_encoder(tmp_path: Path) -> None:
    repo_root = Path(__file__).resolve().parents[2]
