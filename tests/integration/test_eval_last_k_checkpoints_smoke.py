...
def test_eval_last_k_checkpoints_pixel_smoke(tmp_path: Path) -> None:
    ...
    assert (output_root / "last_k_summary.json").exists()
    assert (output_root / "last_k_summary.md").exists()
