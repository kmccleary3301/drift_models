...
def _build_variants() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "description": "ConvNeXt V2 Tiny feature encoder path",
            "extra_train_args": ["--feature-encoder", "convnextv2_tiny", "--convnextv2-weights", "none"],
            "extra_sample_args": [],
        },
        {
            "name": "mae_convnextv2",
            "description": "Paper-closer dual feature path (MAE + ConvNeXt-V2)",
            "extra_train_args": [
                "--feature-encoder",
                "mae_convnextv2",
                "--mae-encoder-arch",
