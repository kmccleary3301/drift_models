...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train -> sample -> eval end-to-end latent smoke runner")
    ...
    parser.add_argument("--decode-mode", choices=("identity", "conv"), default="conv")
    parser.add_argument("--decode-image-size", type=int, default=32)
    parser.add_argument("--postprocess-mode", choices=("clamp_0_1", "tanh_to_0_1", "sigmoid", "identity"), default="sigmoid")
    ...
    parser.add_argument("--experiment-run-id-prefix", type=str, default="EXP-E2E-LATENT")
